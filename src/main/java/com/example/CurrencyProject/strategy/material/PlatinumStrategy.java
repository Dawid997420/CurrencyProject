...
public class PlatinumStrategy implements MaterialStrategy {

    private final MetalScrapper metalScrapper;

    public PlatinumStrategy(MetalScrapper metalScrapper) {
    ...
    public List<Material> getMaterialForDays(String days) {
        ...
        try {
            return metalScrapper.getMaterialForTimePeriod(Metal.platinum, CurrencyCode.PLN,
